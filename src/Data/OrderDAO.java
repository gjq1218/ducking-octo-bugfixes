...
public class OrderDAO extends HibernateDaoSupport {
	...
	public static final String OVERALL_PRICE = "overallPrice";
	...
	public Order findById(java.lang.String id) {
		...
		try {
			Order instance = (Order) getHibernateTemplate().get("Data.Order",
					id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByOverallPrice(Object overallPrice) {
		return findByProperty(OVERALL_PRICE, overallPrice);
	}
